...
from modules.channel_transformer import ChannelTransformer
from modules.deformable_conv import DeformableConv2d
import time
...
class PoseNet(nn.Module):
    ...
    def __init__(self):
        ...
        self.decode = nn.Sequential(
            DeformableConv2d(512, 32, kernel_size=3, stride=1, padding=1, bias=False),
            nn.BatchNorm2d(32),
            nn.ReLU(inplace=True),
            DeformableConv2d(32, 2, kernel_size=1, stride=1, padding=0, bias=False),
            nn.BatchNorm2d(2),
            nn.ReLU(inplace=True)
        )
